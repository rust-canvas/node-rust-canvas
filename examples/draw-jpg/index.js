...
const image = new ImageElement(2560, 2560)
image.src = fs.readFileSync(join(process.cwd(), 'examples', 'fixtures', 'image.jpg'))
...
fs.writeFileSync(join(process.cwd(), 'examples', 'draw-jpg', 'result.jpg'), base64.split(',')[1], {
  encoding: 'base64'
})
